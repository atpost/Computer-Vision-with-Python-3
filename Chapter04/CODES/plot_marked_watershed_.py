...
ax[1].imshow(gradient, cmap=plt.cm.get_cmap("Spectral"), interpolation='nearest')
ax[1].set_title("Local Gradient")

ax[2].imshow(markers, cmap=plt.cm.get_cmap("Spectral"), interpolation='nearest')
ax[2].set_title("Markers")

ax[3].imshow(image, cmap=plt.cm.gray, interpolation='nearest')
ax[3].imshow(labels, cmap=plt.cm.get_cmap("Spectral"), interpolation='nearest', alpha=.7)
